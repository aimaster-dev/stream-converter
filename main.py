...
#         '-hls_flags', 'delete_segments', os.path.join(stream_folder, 'index.m3u8')
#     ]

#     log_file = os.path.join(stream_folder, 'ffmpeg.log')
#     with open(log_file, 'w') as log:
#         subprocess.Popen(ffmpeg_command, stdout=log, stderr=log)
...
#         else:
#             retry_count += 1
#             print(f"FFmpeg process failed with code {process.returncode}. Retrying {retry_count}/{max_retries}...")
#             time.sleep(5)  # Wait before retrying

#     if retry_count == max_retries:
#         print(f"FFmpeg process failed after {max_retries} retries.")
